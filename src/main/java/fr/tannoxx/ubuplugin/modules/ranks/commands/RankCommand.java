 ...
 */
public record RankCommand(RanksModule module) implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command,
        ...
        if (args.length != 2) {
            sender.sendMessage(module.getTranslationManager().getComponent(sender,
                    "<red>Usage: /rank <joueur> <rank></red>"));
            sender.sendMessage(module.getTranslationManager().getComponent(sender,
                    "<gray>Ranks disponibles: " + String.join(", ", getAvailableRanks()) + "</gray>"));
            return true;
        }
