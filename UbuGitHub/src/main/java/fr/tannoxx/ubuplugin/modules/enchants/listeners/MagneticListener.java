 ...
 * - Retrait du système shift + clic droit (remplacé par /toggle)
 */
public class MagneticListener implements Listener {
    ...
    private static final Set<Material> MAGNETIC_TOOLS = EnumSet.of(
            ...
            Material.SHEARS, Material.TRIDENT
    );
    ...
    // ✅ CORRECTION: Ajout de la vérification du toggle
    @EventHandler(priority = EventPriority.HIGHEST, ignoreCancelled = true)
