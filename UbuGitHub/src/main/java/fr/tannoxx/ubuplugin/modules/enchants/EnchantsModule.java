 ...
 * <p>
 * CORRECTIONS v2.0.1:
 * - Ajout cache timberToggles
 * - Ajout cache excavatorToggles (pour Explosive)
...
public class EnchantsModule extends Module {
    ...
    private Cache<UUID, Boolean> timberToggles;        // ✅ AJOUTÉ
    private Cache<UUID, Boolean> excavatorToggles;      // ✅ AJOUTÉ
    ...
    public void onDisable() {
        ...
        if (timberToggles != null) timberToggles.invalidateAll();           // ✅ AJOUTÉ
        if (excavatorToggles != null) excavatorToggles.invalidateAll();     // ✅ AJOUTÉ
    ...
    private void initializeCaches() {
        ...
        // ✅ AJOUTÉ: Cache pour les toggles Timber et Excavator
    ...
    // ✅ AJOUTÉ: Getters pour les nouveaux toggles
    @NotNull
