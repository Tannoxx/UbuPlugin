...
### 🚫 Anti-AFK
- Détection automatique d'inactivité après 5 minutes
- Kick automatique des joueurs AFK
- Avertissement 30 secondes avant le kick
- Notification aux admins lors d'un kick
- Détecte : mouvement, rotation, chat, interactions, minage, etc.
...
antiafk:
  enabled: true
  afk-time: 300        # Temps avant kick (secondes)
  warn-time: 270       # Temps avant avertissement (secondes)
  check-interval: 20   # Intervalle de vérification (secondes)
  notify-admins: true  # Notifier les admins
```
...
- ✅ **Anti-AFK efficace** - Vérifications optimisées
...
### v2.0.0 (2024-12-11)
- ✨ Ajout du module Anti-AFK
- ✨ Suppression du module Anvil
- 🐛 Correction des couleurs MiniMessage dans tous les messages
